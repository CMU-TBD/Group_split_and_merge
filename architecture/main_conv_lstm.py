...
def network(inputs, hidden, lstm=True):
  ...
  if lstm:
    ...
    y_1 = ld.conv_layer(y_0, 3, 1, 64, "encode_3")
  ...
  # conv6
  conv6 = ld.transpose_conv_layer(conv5, 3, 2, 64, "decode_6")
  #conv6 = ld.transpose_conv_layer(conv5, 3, 2, 8, "decode_6")
  # conv7
  conv7 = ld.transpose_conv_layer(conv6, 3, 1, 64, "decode_7")
